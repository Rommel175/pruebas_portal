...
export default function DatosContainer({ profile, estado, localizacionFichaje, setLocalizacionFichaje, horaInicio, horaFinalAprox }: { profile: Profile[], estado: string, localizacionFichaje: string, setLocalizacionFichaje: React.Dispatch<React.SetStateAction<string>>, horaInicio: string | Date, horaFinalAprox: string | Date }) {
    const svg = (
