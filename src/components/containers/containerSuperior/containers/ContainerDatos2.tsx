...
export default function DatosContainer2({ user, estado, localizacion, setLocalizacion }: { user: User, estado: string, localizacion: string, setLocalizacion: React.Dispatch<React.SetStateAction<string>> }) {
    const svg = (
