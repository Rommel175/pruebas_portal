...
import styles from './containerDatos2.module.css'
import ContainerHeader from "../../ContainerHeader";
import Image from "next/image";
import { createClient } from "@/utils/supabase/client";

export default function DatosContainer2({ user, estado, localizacion, setLocalizacion, horaInicio, horaFinalAprox }: { user: User, estado: string, localizacion: string, setLocalizacion: React.Dispatch<React.SetStateAction<string>>, horaInicio: string, horaFinalAprox: string }) {
    const svg = (
